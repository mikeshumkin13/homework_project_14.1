...
*В Ветке feature_homework_16_2 сделано:*
* Оптимизирован Product
Теперь Product наследуется от BaseProduct и LoggingMixin
Логирование включено по умолчанию при создании объекта 
* Добавлены тесты
* Проверка работы BaseProduct
* Тестирование LoggingMixin
* Проверка корректности создания товаров
* Убедились, что все тесты выполняются без ошибок
